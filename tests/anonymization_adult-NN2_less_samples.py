...
def run_with_less_samples(dev_factor, fname_base, orig_x_train, orig_y_train):
    ...
    yminmax_list = [[0.6, 0.9], [0.45, 0.85], [0.55, 1.0], [0.55, 1.0], [0.55, 1.0]]
...
list_fname_base = ['anonymization_adult-NN2_quart_samples',
                   'anonymization_adult-NN2_8th_samples',
                   'anonymization_adult-NN2_16th_samples'] #'anonymization_adult-NN2_half_samples',
